 ...
 */
sharedModule.directive('tmlDebounce', ['sharedConstants', function (sharedConstants) {
    var DEFAULTS = { timeout: sharedConstants.delayTime };

    return {
        restrict: 'A',
        link: function (scope, element, attrs) {
            // normalize directive options
            var options = scope.$eval(attrs.tmlDebounce) || $.extend({}, DEFAULTS);
            if (options === 'leading') {
